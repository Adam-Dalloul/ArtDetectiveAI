...
The full dataset can be viewed [here](https://www.kaggle.com/datasets/kausthubkannan/ai-and-human-art-classification). The dataset was slightly modified by splitting some data between the AI and Non_AI training folders to use them for validation instead.
...
IMAGES OF MODEL DETECTING AI IMAGES AND HUMAN AND ACCURACY
...
<ul>
    ...
    <li><a href="https://github.com/dusty-nv/jetson-inference">Jetson Inference Documentation</a></li>
    <li><a href="https://youtube.com/ ">Video Demonstration</a></li>
</ul>
