...
<p><b>The model was optimized for the highest accuracy as it was trained with googlenet, different epochs, etc. and it the highest accuracy model was found to be 35 epochs on resnet-18.</b></p>
